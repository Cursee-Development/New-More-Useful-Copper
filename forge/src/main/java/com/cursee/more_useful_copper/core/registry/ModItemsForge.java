...
public class ModItemsForge {
    ...
    public static final RegistryObject<Item> COPPER_HELMET = RegistryForge.registerItem("copper_helmet", () ->  new ArmorItem(ModArmorMaterials.COPPER, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1).durability(15*13)));
    public static final RegistryObject<Item> COPPER_CHESTPLATE = RegistryForge.registerItem("copper_chestplate", () ->  new ArmorItem(ModArmorMaterials.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1).durability(15*16)));
    public static final RegistryObject<Item> COPPER_LEGGINGS = RegistryForge.registerItem("copper_leggings", () ->  new ArmorItem(ModArmorMaterials.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1).durability(15*17)));
    public static final RegistryObject<Item> COPPER_BOOTS = RegistryForge.registerItem("copper_boots", () ->  new ArmorItem(ModArmorMaterials.COPPER, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1).durability(15*11)));
