...
public class ModItemsFabric {
    ...
    public static final Item COPPER_SWORD = RegistryFabric.registerItem("copper_sword", () ->  new SwordItem(Tiers.IRON, 3, -2.4F, new Item.Properties().stacksTo(1)));
    public static final Item COPPER_SHOVEL = RegistryFabric.registerItem("copper_shovel", () ->  new ShovelItem(Tiers.IRON, 1.5F, -3.0F, new Item.Properties().stacksTo(1)));
    public static final Item COPPER_PICKAXE = RegistryFabric.registerItem("copper_pickaxe", () ->  new PickaxeItem(Tiers.IRON, 1, -2.8F, new Item.Properties().stacksTo(1)));
    public static final Item COPPER_AXE = RegistryFabric.registerItem("copper_axe", () ->  new AxeItem(Tiers.IRON, 6.0F, -3.1F, new Item.Properties().stacksTo(1)));
    public static final Item COPPER_HOE = RegistryFabric.registerItem("copper_hoe", () ->  new HoeItem(Tiers.IRON, -2, -1.0F, new Item.Properties().stacksTo(1)));
