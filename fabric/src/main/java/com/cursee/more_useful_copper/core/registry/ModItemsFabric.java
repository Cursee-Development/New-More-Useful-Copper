...
public class ModItemsFabric {
    ...
    public static final Item COPPER_HORSE_ARMOR = RegistryFabric.registerItem("copper_horse_armor", () ->  new AnimalArmorItem(ModArmorMaterialsFabric.COPPER, AnimalArmorItem.BodyType.EQUESTRIAN, false, new Item.Properties().stacksTo(1)));

    public static final Item COPPER_HELMET = RegistryFabric.registerItem("copper_helmet", () ->  new ArmorItem(ModArmorMaterialsFabric.COPPER, ArmorItem.Type.HELMET, new Item.Properties().durability(15*13)));
    public static final Item COPPER_CHESTPLATE = RegistryFabric.registerItem("copper_chestplate", () ->  new ArmorItem(ModArmorMaterialsFabric.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(15*16)));
    public static final Item COPPER_LEGGINGS = RegistryFabric.registerItem("copper_leggings", () ->  new ArmorItem(ModArmorMaterialsFabric.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(15*17)));
    public static final Item COPPER_BOOTS = RegistryFabric.registerItem("copper_boots", () ->  new ArmorItem(ModArmorMaterialsFabric.COPPER, ArmorItem.Type.BOOTS, new Item.Properties().durability(15*11)));
